...
- Given $y$, what are the weights $w$? 
  ...
  - $\Phi_j$s are approximated by Gamma distributions.
...
### _Future work 2:_ State-space models and optimization problems
