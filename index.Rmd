...
- An existing approach has its convergence rates depending on the level of heteroskedasticity. 
...
---
### Devided difference matrix and Graphical difference operator
...
$\ell_1$ v.s. $\ell_2$ norms:

- Local adaptivity v.s. global adaptivity;

- Heterogeneous smoothness v.s. homogeneous smoothness.
...
<div style="display: flex; justify-content: center;">
  <img src="gfx/kitty.jpg" width="400" height="250">
  <img src="gfx/denoised-color-kitty-0-1.png" width="400" height="250">
  <img src="gfx/denoised-color-kitty-1-1.png" width="400" height="250">
</div>
_Left to Right:_ Original kitty. Denoised kitty using TF with $k=0$, $\lambda=1$. Denoised kitty using TF with $k=1$, $\lambda=1$.
<div style="display: flex; justify-content: center;">
  <img src="gfx/noised-color-kitty.png" width="400" height="250">
  <img src="gfx/denoised-color-kitty-0-10.png" width="400" height="250">
  <img src="gfx/denoised-color-kitty-1-10.png" width="400" height="250">
</div>
_Left to Right:_ Noised kitty. Denoised kitty using TF with $k=0$, $\lambda=10$. Denoised kitty using TF with $k=1$, $\lambda=10$.

---
### More empirical results

<div style="display: flex; justify-content: center;">
  <img src="gfx/linear_iters.png" width="500" height="300">
  <img src="gfx/prox_iters.png" width="500" height="300">
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="gfx/linear_iters_ord1.png" width="500" height="300">
  <img src="gfx/linear_iters_ord2.png" width="500" height="300">
</div>
<div style="display: flex; justify-content: center;">
  <img src="gfx/linear_iters_ord3.png" width="500" height="300">
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="gfx/prox_iters_ord1.png" width="500" height="300">
  <img src="gfx/prox_iters_ord2.png" width="500" height="300">
</div>
<div style="display: flex; justify-content: center;">
  <img src="gfx/prox_iters_ord3.png" width="500" height="300">
</div>
